...
flags.DEFINE_integer("pool_size", default=1,
      help="Pooling size of the average pooling layer")
...
flags.DEFINE_string("head_initialization", default='one_sided',
      help="Type of the initialization of the positional attention heads, can be in ['one_sided', 'two_sided']")
    ...
    def train_steps(iterator, steps, bsz, global_step):
        ...
        def step_fn(inps, lbls, global_step):
            ...
            with tf.GradientTape() as tape:
                softmax_attn_smoothing = float(global_step)/FLAGS.train_steps
